...
export const storyConfig = {
  ...
  galaxy: {
    ...
    postVideo: {
      ...
      jumpLines: [
        'Для кода нет границ — а между нами и того меньше: мы уже научились прокладывать траектории там, где «нельзя».',
        'Ты — моя личная аномалия: самый тихий сигнал на фоне шума и самый яркий отклик, когда я зову по имени.',
        'Сейчас мы не «переключаем сцену» — мы разгоняем расстояние до тонкой линии, пока оно не станет прикосновением.',
        'Я держу курс на ту точку, где цифры кончаются, а остаётся только мы — и я жду нашего Reset уже не на экране, а вживую.',
      ],
