...
export const storyConfig = {
  ...
  galaxy: {
    ...
    postVideo: {
      ...
      prefaceLines: [
        'Ты увидела не просто видео. Ты вошла глубже.',
        'Все, что было до этого, только подводило тебя сюда.',
        'Теперь я покажу тебе мир, который собрал для тебя.',
      ],
      jumpButtonLabel: 'ОБНУЛИТЬ 1800 КМ',
      jumpHoldLabel: 'Удерживай, чтобы запустить гиперпрыжок',
      jumpLines: [
        'Для любви нет границ. Для меня - тем более.',
        'Ты - моя личная аномалия. Мой самый тихий и самый яркий свет.',
        'Жду момента, когда смогу нажать Reset на этой карте вживую.',
      ],
