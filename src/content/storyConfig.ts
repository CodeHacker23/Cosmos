...
export const storyConfig = {
  ...
  galaxy: {
    ...
    specialStar: {
      ...
      videoDescription:
        'Этот слой откроется на весь экран и станет главным видео-посланием внутри этой галактики.',
      closeLabel: 'Вернуться к звезде',
      bridgeEyebrow: 'NEXT CONSTELLATIONS',
      bridgeTitle: 'После этого карта не закроется, а проснется дальше',
      bridgeDescription:
        'Следующий слой мира - живая карта ваших звезд. Где-то будет текст, где-то видео, где-то маленькое послание, спрятанное внутри света.',
    },
    signals: [
      {
        id: 'truth-signal',
